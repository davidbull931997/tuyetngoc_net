var observer=new MutationObserver(function(a){a.forEach(function(a){"style"!=a.attributeName||"display: none !important;"==a.target.style.cssText||glob_submit||checkInput(glob_submit)})}),glob_submit=!1;observer.observe(document.querySelector("div#manage-page"),{attributes:!0});992>$(window).width()&&$("div.loader-parent").css("display","none");
...
$("p.text-center.copy-right").append(a.getFullYear())}});$(window).resize(function(){});$(window).on("unload",function(){observer.disconnect();"block"==$("div#manage-page").css("display")&&$.post({url:"/admin/adminUnLoad",async:!1})});$("a#login-btn").click(function(a){glob_submit=!0;checkInput(glob_submit);return!1});$("input#username").keypress(function(a){glob_submit=!0;13==a.keyCode&&checkInput(glob_submit)});$("input#password").keypress(function(a){glob_submit=!0;13==a.keyCode&&checkInput(glob_submit)});
$("#custom-search-input > div > span > button").click(function(){searchCustomer()});$("#custom-search-input > div > input").keypress(function(a){13==a.keyCode&&searchCustomer()});$("#add-new-btn").click(function(){addNewCustomer()});
...
$("div#manage-page").css("visibility","hidden").fadeIn(400,function(){$("input#username").val("");$("input#password").val("");$("#custom-search-input > div > input").height($("#custom-search-input > div > input").height()-4);$("#custom-search-input > div > span > button").height($("#add-new-btn").height()+18);resizeFixedTableHead();$("div.loader-parent").fadeOut(400,function(){$("div#manage-page").css("visibility","")})})):(2==a.code?($("div.loader-parent").css("display","none"),$("div#login-page").css("display",
""),swal("Oops...","T\u00e0i kho\u1ea3n ho\u1eb7c m\u1eadt kh\u1ea9u sai!","error")):1==a.code&&($("div.loader-parent").css("display","none"),$("div#login-page").css("display",""),swal("Oops...","T\u00e0i kho\u1ea3n \u0111ang \u0111\u01b0\u1ee3c s\u1eed d\u1ee5ng !","error")),glob_submit=!1)},async:!1})):userExecuteMaliciousScript()}
